...
const translations = {
  ...
  addTrade: 'إضافة صفقة',
  switchToLightTheme: 'التحويل إلى المظهر الفاتح',
  switchToDarkTheme: 'التحويل إلى المظهر الداكن',
  // Dashboard
  ...
  liveMcap: 'القيمة السوقية الحالية',
  entryMcap: 'القيمة السوقية عند الدخول',
  targetMcap: 'القيمة السوقية المستهدفة',
  statusOpen: 'مفتوحة',
  statusProfit: 'ربح',
  statusLoss: 'خسارة',
  ...
  entryByPrice: 'حسب السعر',
  entryByMarketCap: 'حسب القيمة السوقية',
  ...
  marketCapAtEntryLabel: 'القيمة السوقية عند الدخول',
  marketCapOptionalPlaceholder: 'مثال: 1500000 (اختياري)',
  targetMarketCapLabel: 'القيمة السوقية المستهدفة',
  targetPriceLabel: 'سعر الهدف (USD)',
  stopLossLabel: 'وقف الخسارة (USD)',
  stopLossPercentLabel: 'نسبة وقف الخسارة',
  dateLabel: 'التاريخ',
  notesLabel: 'ملاحظات',
  notesPlaceholder: 'مثال: سبب الدخول، ظروف السوق...',
  cancel: 'إلغاء',
  saveTrade: 'حفظ الصفقة',
  calculatedPricePlaceholder: 'محسوب تلقائيًا',
  // Validation errors
  ...
  marketCapRequired: 'القيمة السوقية عند الدخول مطلوبة',
  // Token Preview Card
